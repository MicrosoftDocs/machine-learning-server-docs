...
Instructions for installation can be found at [Install R Server on Hadoop](rserver-install-hadoop-805.md) and [Install R Server on Linux](rserver-install-linux-server.md).
