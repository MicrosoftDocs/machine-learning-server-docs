...
The DeployR Server should ideally be the only local process that should connect to RServe. To help ensure this is the case, a username and password is required to validate any connection between RServe and a client process. However, there exist several vulnerabilities of which you should be aware. They are:
