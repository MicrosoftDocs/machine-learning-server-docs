...
For DeployR 8.0.5, the default ports are:
-   DeployR HTTP port: 8050
-   DeployR HTTPS port: 8051
-   DeployR event console port: 8056

For DeployR 8.0.0, the default ports are:
...
4.  Click **OK**.
5. Repeat 4-7 for all three rules.   
