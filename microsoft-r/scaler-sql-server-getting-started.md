...
Instructions for installing R for SQL Server can be found at [Create a Standalone R Server on Windows](https://msdn.microsoft.com/library/mt695941.aspx) and [Revolution R Enterprise 2016 build 8.0.0 Windows Installation Instructions](https://msdn.microsoft.com/microsoft-r/rserver-install-windows).
