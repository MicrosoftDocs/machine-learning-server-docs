...
**Pretrained models** for sentiment analysis and image featurization can also be installed and deployed with MicrosoftML. For more information on the pretrained models and samples, see [R samples for MicrosoftML](sample-microsoftml.md) and [Python samples for MicrosoftML](sample-microsoftml-python.md).
...
[R samples for MicrosoftML](sample-microsoftml.md) and [Python samples for MicrosoftML](sample-microsoftml-python.md) show how to use pretrained models for sentiment analysis and image featurization.