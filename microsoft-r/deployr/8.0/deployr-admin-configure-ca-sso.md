...
5.  Click **OK**.
    ...
    ![Create Agent](/microsoft-r/media/deployr-admin-configure-ca-sso/001-createagent.jpg)
...
6.  Click **OK**.
    ...
    ![Create Agent Group](/microsoft-r/media/deployr-admin-configure-ca-sso/002-createagentgroup.jpg)

7.  In the **Name** field, enter the name `deployrGroup`.

8.  Click **Add/Remove** button.

    ![Create Agent Group](/microsoft-r/media/deployr-admin-configure-ca-sso/003-createagentgroup2.jpg)
...
2.  Click **Create Agent Configuration**.
    ...
    ![Create Agent Configuration](/microsoft-r/media/deployr-admin-configure-ca-sso/004-createagentconfig.jpg)

3.  Select **Create a copy of an object of type Agent Configuration**.

4.  Select `ApacheDefaultsSettings`.

    ![Modify Agent Configuration](/microsoft-r/media/deployr-admin-configure-ca-sso/005-modifyagentconfig.jpg)
...
1.  Click on the pencil icon next to the `deployrApacheSettings` object to enter the configuration page.
    ...
    ![Configuration page](/microsoft-r/media/deployr-admin-configure-ca-sso/006.jpg)
...
5.  Click **OK**.
    ...
    ![Modify Agent Configuration](/microsoft-r/media/deployr-admin-configure-ca-sso/007.jpg)
...
8.  Click **OK**.
    ...
    ![Modify Agent Configuration](/microsoft-r/media/deployr-admin-configure-ca-sso/008.jpg)
...
4.  In the **General** tab, enter `deployrDomain` in the **Name** field.
    ...
    ![Create New Domain](/microsoft-r/media/deployr-admin-configure-ca-sso/009.jpg)

5.  In the **User Directory** window, click **Create** and fill in the following info:

    ![Create User Directory](/microsoft-r/media/deployr-admin-configure-ca-sso/010.jpg)
...
3.  Enter the following information in the form.
    ...
    ![Create User Directory](/microsoft-r/media/deployr-admin-configure-ca-sso/011.jpg)

4.  In the **Rules** section, click **Create**.

5.  Enter the following information in the form.

    ![Create User Directory](/microsoft-r/media/deployr-admin-configure-ca-sso/012.jpg)
...
6.  Create the following sub-realms for your configuration using the values in the following table. There are no rules associated with the sub-realms.
    ...
    ![Create Realm](/microsoft-r/media/deployr-admin-configure-ca-sso/013.jpg)
...
2.  Enter the following information in the form.
    ...
    ![Create Response](/microsoft-r/media/deployr-admin-configure-ca-sso/014.jpg)
...
4.  Fill in the information as shown in the image below.
    ...
    ![Create Response Attribute](/microsoft-r/media/deployr-admin-configure-ca-sso/015.jpg)
...
3.  Enter the following information in the form.
    ...
    ![Create Response](/microsoft-r/media/deployr-admin-configure-ca-sso/016.jpg)

4.  Click **Add/Remove** and add `deployrGroupResponse`.

    ![Create Response](/microsoft-r/media/deployr-admin-configure-ca-sso/017.jpg)
...
3.  Fill in the following information in the form.
    ...
    ![Create Policy](/microsoft-r/media/deployr-admin-configure-ca-sso/018.jpg)

4.  Click the **Users** tab.

    ![Add Members](/microsoft-r/media/deployr-admin-configure-ca-sso/019.jpg)

5.  Click **Add Members**.

    ![Add Members](/microsoft-r/media/deployr-admin-configure-ca-sso/020.jpg)

6.  Select `CN=scriptGroup,OU=engineering,DC=revolution,DC=com`.

7.  Click **OK**.

    ![Add Members](/microsoft-r/media/deployr-admin-configure-ca-sso/021.jpg)
