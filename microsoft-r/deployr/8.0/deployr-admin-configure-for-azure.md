...
1.  Log into the Azure portal and take note of the **Public IP address**.
    ...
    ![Public IP Address in Azure Portal](/microsoft-r/media/deployr-admin-configure-for-azure/azure-public-ip.png)
...
2.  Click the **Resource Group** name.
    ...
    ![Rules](/microsoft-r/media/deployr-admin-configure-for-azure/azure-resource-group.png)
...
6.  Click the **Add** button to create an inbound security rule for each DeployR port as follows:
    ...
    3.  Set the **Source Port Range** to the `*` character.
        ...
        ![Rules](/microsoft-r/media/deployr-admin-configure-for-azure/azure-source-port-range.png)
...
![Rules](/microsoft-r/media/deployr-admin-configure-for-azure/azure-inbound-rules.png)
