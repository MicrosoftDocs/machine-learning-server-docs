...
Microsoft R Client works with the following flavors of R Server. 
...
|Microsoft R Server for Hadoop|R Server for Hadoop 2016<br>(build 8.0.5) with tweaks <b>*</b> |R Server for Hadoop 2016<br>(build 8.0.5)|
