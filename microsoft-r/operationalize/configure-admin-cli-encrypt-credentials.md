...
1. Open the administration tool to encrypt the secret:
   + For Machine Learning Server 9.3 and later, use `admin` extension of the Azure Command Line Interface ([Azure CLI](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest)) to encrypt your credentials.
