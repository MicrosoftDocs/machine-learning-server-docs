...
In Machine Learning Server 9.3 and later, you can use `admin` extension of the Azure Command-Line Interface ([Azure CLI](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest)) to set up and manage your configuration, including stopping and starting services.
