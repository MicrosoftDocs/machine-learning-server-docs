...
|----|-----|:---:|
|`-silentoneboxinstall <password>`|Sets up a [one-box configuration](configuration-initial.md) silently<br>  and sets an admin  password. For example: <br>`-silentoneboxinstall mypass123`|9.1|
