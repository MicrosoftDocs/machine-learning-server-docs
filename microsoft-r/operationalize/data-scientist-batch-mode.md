...
for(i in seq(batchRes$totalItemCount)) {
  ...
  for (fileName in files) {
    content <- txBatch$artifactContent(i, fileName)
...
| `listArtifacts` |List of every file that was generated by this execution index  |[view](#listartifacts-fx)|
| `artifactContent` |Print the contents of the named file generated by the batch execution  |[view](#artifactcontent-fx)|
...
Retrieve a list of every file that was generated during the batch execution for a given data record, or index, with `listArtifacts()`. This can be made part of a loop to get the list of the files for every data record (see workflow example for a loop). 
...
<a name="artifactcontent-fx"></a>

### Display file contents

Display the file contents of a named file returned in the above list with `artifactContent()`. R Server returns the ID for the named batch object. 

**Syntax:** `artifactContent(index, fileName)`
