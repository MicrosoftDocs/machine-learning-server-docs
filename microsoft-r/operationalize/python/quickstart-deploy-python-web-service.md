...
> * The [Python client libraries for remote access to Machine Learning Server](https://docs.microsoft.com/en-us/machine-learning-server/install/python-libraries-interpreter) installed on your machine.
