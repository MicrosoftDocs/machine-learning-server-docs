...
This feature is still underdevelopment. In very rare cases, the [delete_service_pool](../../python-reference/azureml-model-management-sdk/mlserver.md#delete_service_pool) command may fail to actually delete the pool on the computeNode. Please issues a new [delete_service_pool](../../python-reference/azureml-model-management-sdk/mlserver.md#delete_service_pool) command if you encountered this situation. Please use the [get_service_pool_status](../../python-reference/azureml-model-management-sdk/mlserver.md#delete_service_pool) command to monitor the actually status of dedicated pools on the computeNode.
 ```python
 # Deletes the dedicated session pool and releases resources
