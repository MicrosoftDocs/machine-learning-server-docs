...
There is a defect in our azureml-model-management-sdk package: sending multiple variables as inputs is returning keyerror. Alternative: DataFrames can be used as the input type.
