...
To benefit from Microsoft Learning Server’s deployment and operationalization features, configure it to act as a deployment server and host analytic web services.
