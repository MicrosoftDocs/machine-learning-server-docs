...
| [Volume Licensing Service Center (VLSC)](http://go.microsoft.com/fwlink/?LinkId=717966&clcid=0x409) | Enterprise | Sign in, search for "SQL Server 2017" <sup>1</sup>, and then choose a per-core or CAL licensing option. A selection for **Machine Learning Server 9.2.1** is provided on this site. |

<sup>1</sup> Machine Learning Server for Windows is licensed as a SQL Server enterprise feature, regardless of whether you install it through SQL Server Setup or as download from a Microsoft web site.
