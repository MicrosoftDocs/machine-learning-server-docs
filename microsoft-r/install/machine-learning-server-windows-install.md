...
| *pending* - [Visual Studio Subscriptions](https://msdn.microsoft.com/subscriptions/downloads/hh442898.aspx) | Developer or Enterprise | Subscribers can download software at given subscription levels. Depending on your subscription, you can get either edition. |
...
Machine Learning Server can be with an R IDE on the same box, but you can also [enable the server](../operationalize/configure-start-for-administrators.md#configure-server-for-operationalization) to [host web services](../operationalize/concept-what-are-web-services.md) and to allow remote server connections.
...
Configuration steps are few and the benefits are tangible, so please take a few minutes to complete this task.
