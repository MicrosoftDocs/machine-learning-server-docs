...
```
 ...
 ### `trainers`
 A list of trainers with their arguments. The trainers are created by using [fastTrees](fastTrees.md), [fastForest](../../r-reference/microsoftml/fastforest.md), [fastLinear](../../r-reference/microsoftml/fastlinear.md), [logisticRegression](logisticRegression.md) or [neuralNet](neuralNet.md). 
