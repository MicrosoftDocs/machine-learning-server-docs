...
## [Install R Server for Hadoop](rserver-install-hadoop.md)
...
## [Install R Server for Teradata DB](scaler-teradata-getting-started.md)
...
## [Install Python dev environment](r-client-get-started.md)
