...
#### [Cloudera installation](rserver-install-cloudera.md)
...
### [Command line installation](rserver-install-hadoop.md)
...
### [Get started: ScaleR on Hadoop MapReduce](scaler-hadoop-getting-started.md)
### [Get started: ScaleR on Apache Spark](scaler-spark-getting-started.md)
#### [Uninstall from Hadoop](rserver-install-uninstall-upgrade.md)
#### [Install older versions](rserver-install-hadoop-901.md)
