...
#### [Configure: One-box](operationalize/operationalize-machine-learning-server-one-box.md)
##### [9.2.1](operationalize/operationalize-machine-learning-server-one-box.md)
##### [9.0/9.1](install/operationalize-r-server-one-box-config.md)
#### [Configure: Enterprise](operationalize/operationalize-machine-learning-server-enterprise.md)
##### [9.2.1](operationalize/operationalize-machine-learning-server-enterprise.md)
