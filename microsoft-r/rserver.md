...
|Other packages | Additional packages are distributed with R Client and R Server, such as [RevoPemaR](r-reference/revopemar/pemar.md). For the complete list, see [Package reference on MSDN](package-reference.md). |
