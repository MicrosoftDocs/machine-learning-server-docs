...
*   an [RxTeradata](../../r-reference/revoscaler/rxteradata.md) data source that has the `table` specified 
...
* 
 If the `table` argument is an [RxTeradata](../../r-reference/revoscaler/rxteradata.md) or [RxOdbcData](../../r-reference/revoscaler/rxodbcdata.md) data source, the table name specified in the data source is searched for in the database specified in the data source.
