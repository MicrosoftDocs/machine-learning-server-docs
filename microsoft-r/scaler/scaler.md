...
|`rxRngGetStream`   | |Support for Parallel Random Number Generation.|<small>[See package](scaler.md#findmore)</small>|
...
|`rxLocateFile`| |Get the first occurrence of a specified input file in a set of specified paths.|<small>[See package](scaler.md#findmore)</small>|
